import { Button, BarChart, ErrorState, Skeleton } from "@/components";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
export default function Cashflow() {
  ...
  if (isError)
    return (
      <div className="md:col-span-2 lg:col-span-4 border border-bor rounded-xl p-4 flex flex-col">
        <ErrorState
